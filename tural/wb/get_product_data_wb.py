...
def main():
    ...
    CsvHandler(result_filename).create_headers_csv_semicolon(['title', 'price', 'discount_price', 'brand', 'category', 'sku', 'url', 'url_pic'])
    ...
    for product in products:
        ...
        """
    print(df_all)
    df_all.to_excel(r'C:\PyProjects\poject_1\tural\ozon\ozon_result.xlsx', index=False)
